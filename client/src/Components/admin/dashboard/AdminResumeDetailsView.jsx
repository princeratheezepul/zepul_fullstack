...
const AdminResumeDetailsView = ({ resume, onBack, onStatusUpdate }) => {
  ...
  // Debug logging
  console.log('AdminResumeDetailsView - resume:', resume);
  console.log('AdminResumeDetailsView - resume.addedNotes:', resume.addedNotes);
  ...
  const handleShortlist = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/admin/resumes/${resume._id}`, {
        method: 'PATCH',
        headers: { 
  ...
  const handleSaveNote = async () => {
    ...
    try {
      ...
      // Save to resume's addedNotes field (admin notes about this specific candidate)
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/admin/resumes/${resume._id}`, {
        method: 'PATCH',
        headers: { 
          'Content-Type': 'application/json',
...
export default AdminResumeDetailsView; 